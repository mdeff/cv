...
%\name{mdeff \hfill}{Michaël Defferrard}
...
%\quote{\enquote{I make intelligent systems/machines; better by leveraging structure.}}
%\quote{\enquote{I research intelligence; better by leveraging structure.}}
%\quote{\enquote{I strive for excellence—in research and managing teams.}} % pushing me and teams/orgs to do excellent work
...
%         % Background and experience in electronic/chip design.
...
On the fundamental and curiosity-driven side, I leverage the fundamental principles that underpin our reality—like topology, geometry, symmetries, causality—to make machines learn better. % more efficiently
On the applied and problem-driven side, I research how that can help the design of semiconductor chips;
...
% was recognized in the top 8% of EPFL theses (Thesis Distinction)
...
\begin{itemize}
    ...
    \item Examiners: \href{http://yann.lecun.com}{Yann LeCun} (NYU, FAIR), \href{https://staff.fnwi.uva.nl/m.welling}{Max Welling} (UvA, MSR), \href{https://people.epfl.ch/martin.jaggi}{Martin Jaggi} (EPFL).
    \item Thesis awarded as in the \href{https://www.epfl.ch/education/phd/phd-awards/thesis-distinction/}{best 8\%} and nominated for the \href{https://www.epfl.ch/education/phd/phd-awards/}{best thesis award}.
\end{itemize}
}
...
\cvitem{2022}{\href{https://www.epfl.ch/education/phd/phd-awards/thesis-distinction/}{EPFL PhD Thesis Distinction} in Electrical Engineering. Awards the best 8\%.} % (top 8\%)
    % https://www.epfl.ch/education/phd/edee-electrical-engineering/edee-awards-laureates/
    % Awarded to the 8\% best PhD theses of each EPFL Doctoral Program. Given to the 8\% best theses. Rewards/awards the best 8%.
...
% \cvitem{2022}{Invited to apply for the \href{https://www.epfl.ch/research/awards/lopez-loreta-prize/}{Lopez-Loreta Prize} (1M EUR for a 5-year research project).} % all PhD students nominated for a prize are invited
\cvitem{2021}{Nominated for the \href{https://www.epfl.ch/education/phd/phd-awards/}{EPFL Doctorate award}. Awards the best $2$ of $\sim 420$ theses.} 
% Nominated for Doctorate Award (top 0.5\%), Thesis Distinction (top 8\%), Doctoral Thesis Award in Electrical Engineering.
