...
\begin{itemize}  % hard skills (not soft, which are demonstrated in letter and interview)
    \item Knowledgeable and passionate about structure and learning.
%    \item Experienced with graph neural networks and related methods.
    \item Experienced with ML/DL/NNs on graphs/networks/manifolds/meshes/complexes.
...
\begin{itemize}
    \item Thesis: Learning better by exploiting the topology, geometry, and symmetries of the structure supporting data.
    % \item Topics: machine learning and signal processing on graphs, symmetries and equivariance, topology and geometry.
        % deep learning and graphs, geometric deep learning
    \item Advized by Prof.\ Pierre Vandergheynst.
\end{itemize}
}
...
\begin{itemize}
    ...
    \item Courses on signal processing, data analysis, machine learning.
\end{itemize}
}
...
\cvitem{Collaborations}{I enjoy to tackle real problems by collaborating with domain experts. So far in Neuroscience, Cosmology, Protein Design \& Imaging, Weather \& Climate Sciences.}
