...
\cventry[\spacing]{2015--now}{PhD Machine Learning}{École Polytechnique Fédérale de Lausanne (EPFL)}{}{}{%
\begin{itemize}
    \item Thesis: Leveraging topology, geometry, and symmetries for efficient Machine Learning.
    ...
    \item Adviser: Prof.\ Pierre Vandergheynst.
    \item Examiners: Prof.\ Martin Jaggi (EPFL), Prof.\ Max Welling (UvA, MSR), Prof.\ Yann LeCun (NYU, FAIR).
\end{itemize}
}
...
\begin{itemize}
    \item Courses and projects on electronic hardware design, analog and digital circuits, embedded systems.
...
%    \item Spent a year (ERASMUS) at the Fachhochschule München.
...
% Vocational training in Electronics while working for a company.
...
\cventry[\spacing]{2014--now}{Research Assistant}{École Polytechnique Fédérale de Lausanne (EPFL)}{}{}{%
...
My work pioneered graph ML research and proved useful in tackling important real-world problems.
...
\cvitem{Publications}{%
    \textbf{10+ papers, 4500+ citations, h-index of 10.}
    Published at top ML conferences (NeurIPS and ICLR) as well as domain-specific journals (NeuroImage, Astronomy \& Computing) and conferences (The Web Conference, ISMIR).
...
\cvitem{Leadership}{I led research efforts and events. I serve as the president of a \href{https://fanfare-orsonnens.ch}{band of 40 musicians} and a leadership member at a \href{https://villorsonnens.ch/service-technique/service-du-feu}{firefighting brigade of 80}.}
\cvitem{Collaborations}{I enjoy to tackle real-world problems by assembling interdisciplinary collaborations. So far in Neuroscience, Cosmology, Biology, Geoscience.}
% with applications downstream, with math upstream
\cvitem{Organization}{%
    \listitemsymbol{} \href{https://www.ml4earth.org}{Machine Learning for Earth}, Seminar, 2019--now. \newline
