...
\cventry[\spacing]{2015–2021}{PhD Machine Learning}{École Polytechnique Fédérale de Lausanne (EPFL)}{}{}{%
\begin{itemize}
    ...
    \item Examiners: Martin Jaggi (EPFL), Max Welling (UvA, MSR), Yann LeCun (NYU, FAIR).
\end{itemize}
}
...
%    \item French and German bilingual studies.
    \item Exchange year (Erasmus+) at the Hochschule München.
...
\cventry[\spacing]{2005–2009}{Federal VET Diploma in Electronics}{EPAI}{Fribourg CH}{\textit{GPA 96\%}}{%
