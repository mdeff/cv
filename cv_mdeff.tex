...
%\section{Objectives}  % About, Key Skills, Summary
...
Listed at \url{https://scholar.google.ch/citations?user=Ztj2-gUAAAAJ}.
% todo: add approximate citation counts?

% Alternatives:
%\cvlistitem{\bibentry{fma_dataset}}
%\cvlistitem{\fullcite{fma_dataset}}

%\section{Software}
\autopubsoftware
% todo: usage metrics? (downloads, stars)

\section{Awards}  % Awards, Scholarships, Achievements, Honours

% todo: more? remove?
\cvitem{2016, 2017}{Google PhD Fellowship Nominee}
\cvitem{2014}{Silicon Valley Startup Camp}
\cvitem{2012}{Award for excellence, Phonak Communications}
...
\cvitem{2009}{Award for excellence, Union Patronale du Canton de Fribourg}
...
% Either here or on website. Boring to repeat.
% Probably more visible on website.

\section{Professional Services}

\subsection{Events Organization}
\cvitem{2018}{\href{https://www.crowdai.org/challenges/www-2018-challenge-learning-to-recognize-musical-genre}{Musical Genre Recognition Challenge}, The Web Conference (WWW)}
\cvitem{2017}{\href{https://osip2017.epfl.ch}{Open Science in Practice Summer School}, EPFL}
\cvitem{2017, 2018}{\href{https://bmvc2017.london/dlid}{Deep Learning on Irregular Domains Workshop}, BMVC}

\subsection{Reviewing Activities}
%TODO: add all
\cvitem{}{IEEE Transactions on Medical Imaging (TMI)}  % 2019
\cvitem{}{IEEE Transactions on Image Processing (TIP)}  % 2019
\cvitem{}{Transactions on Pattern Analysis and Machine Intelligence (TPAMI)}  % 2017
\cvitem{}{IEEE Transactions on Neural Networks and Learning Systems (TNNLS)}  % 2017
\cvitem{}{IEEE GlobalSIP}  % 2017
\cvitem{}{Journal of Selected Topics in Signal Processing (J-STSP)}  % 2016
...
\cvlistitem{Musician in two bands, playing at the Swiss national championship}
\cvlistitem{Firefighter officer}
