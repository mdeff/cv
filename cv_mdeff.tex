...
%\section{Objective}  % Objective(s), About, Summary
% My research interests / Life goals
% todo: as the blue quote?

% (Key) Skills (computer skills, communication skills (writings?)
...
List with statistics at \url{scholar.google.ch/citations?user=Ztj2-gUAAAAJ}.
% Full list at
...
% reviewer, editor, chair, organizer?, thesis committees?
